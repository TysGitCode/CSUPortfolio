...
*   **Batch Script** (In addition to the Python cleaning script, this project includes a **Windows batch file** used to automate and operationalize the COBRA file‑cleaning process.)
